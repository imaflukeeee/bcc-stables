...
Horses = { -- Gold to Dollar Ratio Based on 1899 Gold Price / sellPrice is 60% of cashPrice / Cash Price is Regular Game Price
	...
	},
	{
		...
		colors = {
			...
			['a_c_horse_morgan_flaxenchestnut']   = { color = 'Flaxen Chestnut', cashPrice = 2500, invLimit = 20, job = {} },
			['a_c_horse_morgan_liverchestnut_pc'] = { color = 'Liver Chestnut',  cashPrice = 2500, invLimit = 20, job = {} },
            ['a_c_horse_morgan_palomino']         = { color = 'Palomino',        cashPrice = 2500, invLimit = 20, job = {} },
		}
	},
	{
		breed = 'American Paint',
		colors = {-- Only Players with Specified Job will See that Horse to Purchase in the Menu
			['a_c_horse_americanpaint_greyovero']     = { color = 'Grey Overo',     cashPrice = 10000, invLimit = 50, job = {} }, -- Job Example: {'police', 'doctor'}
